...
class HandoffsCubit extends Cubit<HandoffsState> {
  ...
  StreamSubscription<Map<String, dynamic>>? _handoffAckSub;
  ...
  void _listenForHandoffAcknowledged() {
    _handoffAckSub = _socketClient
